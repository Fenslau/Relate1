...
<div class="container">
  ...
  <h2 class="m-3 text-center text-uppercase">Собрать и анализировать посты</h2>
    ...
    @if (empty($items))
      ...
      <div class="row">
        <div class="col-md-4"><a href="/images/H01.jpg" data-fancybox> <img class="p-0 col" src="/images/H01.jpg" alt="Теги, активные авторы, количество запросов"></a></div>
      ...
      <div class="row">
        ...
        <div class="col-md-4"><a href="/images/H02.jpg" data-fancybox> <img class="p-0 col" src="/images/H02.jpg" alt="Распределение по регионам"></a></div>
        <div class="col-md-2">
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-4 mt-md-n5"><a href="/images/H03.jpg" data-fancybox> <img class="p-0 col" src="/images/H03.jpg" alt="Статистика по авторам"></a></div>
      </div>
      <div class="row">
        <div class="col-md-4"><a href="/images/H0.jpg" data-fancybox> <img class="p-0 col" src="/images/H0.jpg" alt="Фильтры по критериям"></a></div>
        <div class="col-md-8">
          <br /><br />
