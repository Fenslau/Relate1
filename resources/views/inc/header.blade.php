...
<div class="pb-2 container-fluid vk-top-bg text-white">
    ...
    <div class="d-flex justify-content-around">
      <div class="mr-auto p-2">
        ...
        <div class="text-uppercase lh-sm mt-n3 text-right">
    ...
    <nav class="d-flex justify-content-around align-items-start navbar">
      <div class="m-1 service">
        <a class="nav-link bg-white rounded font-weight-bolder vk-top-color lh-m text-center text-uppercase" href="#">Группы с&nbsp;открытой стеной</a>
      ...
      <div class="m-1 service">
        <a class="nav-link bg-white rounded font-weight-bolder vk-top-color lh-m text-center text-uppercase" href="#">Группы с&nbsp;похожей ЦА</a>
      ...
      <div class="m-1 service">
        <a class="nav-link bg-white rounded font-weight-bolder vk-top-color lh-m text-center text-uppercase" href="#">Собрать&nbsp;базу подписчиков групп</a>
      ...
      <div class="m-1 service">
        <a class="nav-link bg-white rounded font-weight-bolder vk-top-color lh-m text-center text-uppercase" href="#">Мониторинг новых&nbsp;подписчиков в группах</a>
      ...
      <div class="m-1 service">
        <a class="nav-link bg-white rounded font-weight-bolder vk-top-color lh-m text-center text-uppercase" href="#">Собрать и&nbsp;анализировать посты</a>
    ...
    <div class="conainer">
      <form action="opros" method="post">
        <div class="input-group">
          ...
          <button class="btn btn-sm btn-outline-primary text-white" type="submit" id="opros">Отправить</button>
        </div>
      </form>
    </div>
</div>
