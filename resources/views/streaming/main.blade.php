    ...
    <div class="row">
      <div class="col">
        ...
        <ul class="demo-stream">
          ...
          <li><b>Система сама проанализирует и отобразит весь объем найденных упоминаний по датам.</b> Вы увидите, как менялось количество публичных сообщений (постов/комментариев) о бренде/компании, например, в течение года или нескольких месяцев под влиянием различных факторов (событий, рекламных компаний и др.).</li>
          <li><b>Система визуализирует статистику по авторам в виде дашборда,</b> которые распределяются <b>по полу, возрасту, региону, количеству подписчиков. Также система покажет вам список самых активных авторов.</b> Вы лучше разберетесь, кто целевая аудитория бренда/компании, кто является амбассадором, а кто хейтером. Дашборд отображает статистику как по пользователям, так и по группам.</li>
          <li><b>Облако тэгов и ключевых слов</b> выделит для вас основную мысль всех упоминаний о бренде или компании.</li>
          <li><b>Фильтры</b> помогут выбрать <b>только те упоминания (посты),</b> которые разместили <b>пользователи с заданным социально-демографическим профилем.</b> Вы легко найдете, что пишут о бренде/компании мужчины или женщины определенного возраста из заданного региона/страны. Фильтры настроены как по пользователям, так и по группам.</li>
