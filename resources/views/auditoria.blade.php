  ...
  <form class="" id="search-submit" action="{{ route('auditoria') }}" method="post">
    ...
    <div class="search-form row pb-5">
      <div class="col-md-6 ">
        ...
        <div class="">
          <p>Введите <b>ссылку на группу</b> из ВК или <b>ID группы</b>, в которой есть ваша целевая аудитория, после чего нажмите кнопку "Начать поиск". Далее система проанализирует базу групп ВК и найдет список групп, где есть похожая целевая аудитория. Когда поиск будет закончен, на экране появится ссылка на скачивание Excel-файла. Если исходная группа большая, то время поиска может увеличиться до 2 часов и более. Рекомендуется указывать группы не более 30 000 подписчиков, для более точного и уникального результата.</p>
        </div>
      </div>
