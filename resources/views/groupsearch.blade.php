    ...
    <div class="search-form row pb-5">
      ...
      <div class="col-md-4">
        ...
        <div class="font-weight-light mb-3">
          <span class="h5 d-block font-weight-bold">Сформулируйте запрос</span>
        ...
        <div class="font-weight-light mb-3">
          <span class="h5 d-block font-weight-bold">Задайте критерии для поиска групп</span>
        ...
        <div class="font-weight-light mb-3">
          <span class="h5 d-block font-weight-bold">Поиск групп</span>
